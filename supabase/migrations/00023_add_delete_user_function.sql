-- Create RPC function to delete a user and all related data
-- This function will cascade delete all user-related records
...
BEGIN
  ...
  -- Delete documents uploaded by the user
